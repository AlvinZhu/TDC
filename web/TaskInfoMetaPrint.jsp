...
<table width="720" border="2" align="center" cellspacing="0">
    ...
    <tr>
        ...
        <td width="240" height="40" colspan="3" align="center" valign="middle" style="text-align: center"><s:property
                value="%{taskId}"/></td>
        <td width="80" height="40" colspan="1" align="center" valign="middle" style="text-align: center">产品名称</td>
        <td width="160" height="40" colspan="2" align="center" valign="middle" style="text-align: center"><s:property
                value="%{drawingName}"/></td>
