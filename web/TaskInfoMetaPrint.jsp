...
<s:iterator value="listSet" id="list" status="st">
    <table width="720" border="2" align="center" cellspacing="0">
        ...
        <tbody>
        <tr>
            <td colspan="11" rowspan="2" align="center" valign="middle" nowrap style="text-align: center; font-size: xx-large; font-weight: bold;"><img src="logo.jpg" width="102" height="33" alt=""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;产&nbsp;品&nbsp;质&nbsp;量&nbsp;跟&nbsp;踪&nbsp;卡&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        ...
        <tr>
            <td colspan="3" align="center" valign="middle" nowrap style="text-align: center; font-size: small;">产品名称</td>
            <td colspan="4" align="center" valign="middle" nowrap style="text-align: center; font-size: small;">生产令/批次号</td>
            <td colspan="3" align="center" valign="middle" nowrap style="text-align: center; font-size: small;">材料名称或牌号</td>
            <td colspan="3" align="center" valign="middle" nowrap style="text-align: center; font-size: small;">材料规格</td>
        </tr>
        <tr>
            <td colspan="3" align="center" valign="middle" style="text-align: center; font-size: small;"><s:property value="%{drawingName}"/></td>
            <td colspan="4" align="center" valign="middle" style="text-align: center; font-size: small;"><s:property value="%{taskId}"/></td>
            <td colspan="3" align="center" valign="middle" style="text-align: center; font-size: small;">&nbsp;</td>
            <td colspan="3" align="center" valign="middle" style="text-align: center; font-size: small;">&nbsp;</td>
        </tr>
        <tr>
            <td height="12" colspan="13" align="center" valign="middle" style="text-align: center; font-size: 24;"></td>
...
<s:iterator value="#list" id="p2" status="st2">
        <tr>
            ...
            <td height="120" align="center" valign="middle" style="text-align: center"><s:property value="#p2.procedureId"/></td>
            </s:if>
            <s:else>
                <td height="120" align="center" valign="middle" style="text-align: center">&nbsp;</td>
            </s:else>
            <td height="120" align="center" valign="middle" style="text-align: center"><s:property value="#p2.procedureName"/></td>
            <td height="120" align="center" valign="middle" style="text-align: center"><s:property value="#p2.workHour"/></td>
            <td height="120" align="center" valign="middle" style="text-align: center">&nbsp;</td>
            <td height="120" align="center" valign="middle" style="text-align: center">&nbsp;</td>
            <td height="120" align="center" valign="middle" style="text-align: center">&nbsp;</td>
            <td height="120" align="center" valign="middle" style="text-align: center">&nbsp;</td>
            ...
            <s:if test='%{#p2.procedureId!=0}'>
            <td height="120" colspan="2" align="center" valign="middle" style="text-align: center"><img style="height:100px;width:100px"
                                                                                                        src="<s:url value="TdcOut.action?procedureId=%{#p2.procedureId}"/>"/></td>
            </s:if>
            <s:else>
                <td height="120" colspan="2" align="center" valign="middle" style="text-align: center"><img style="height:100px;width:100px" src=""/>
                </td>
            </s:else>
        </tr>
</s:iterator>
    ...
    <h1 style="text-align: center"><img src="logo.jpg" width="102" height="33" alt=""/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;原材料（领）备料单&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</h1>
    <table width="720" border="2" align="center" cellspacing="0">
        <caption style="text-align: center; width: 720px; height: 20px;">
            制 单 人： &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 制单日期：<s:property value="%{date}"/>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; QR04-003
        </caption>
        <tbody>
        <tr>
            <td width="80" height="40" colspan="1" align="center" valign="middle" style="text-align: center">生产令号 </td>
            <td width="240" height="40" colspan="3" align="center" valign="middle" style="text-align: center"><s:property value="%{taskId}"/></td>
            <td width="80" height="40" colspan="1" align="center" valign="middle" style="text-align: center">产品名称</td>
            <td width="160" height="40" colspan="2" align="center" valign="middle" style="text-align: center"><s:property value="%{drawingName}"/></td>
            <td width="80" height="40" colspan="1" align="center" valign="middle" style="text-align: center">计划数量</td>
            <td width="80" height="40" colspan="1" align="center" valign="middle" style="text-align: center"><s:property value="%{num}"/></td>
        </tr>
        <tr>
            <td width="80" height="40" colspan="1" align="center" valign="middle" style="text-align: center">产品图号</td>
            <td width="240" height="40" colspan="3" align="center" valign="middle" style="text-align: center"><s:property value="%{drawingId}"/></td>
            <td width="80" height="40" colspan="1" align="center" valign="middle" style="text-align: center">毛坯尺寸</td>
            <td width="160" height="40" colspan="2" align="center" valign="middle" style="text-align: center">&nbsp;</td>
            <td width="80" height="40" colspan="1" align="center" valign="middle" style="text-align: center">毛坯重量<br/>（kg）</td>
        ...
        <tr>
            ...
            <td width="240" height="40" colspan="3" align="center" valign="middle" style="text-align: center">&nbsp;</td>
            <td width="80" height="40" colspan="1" align="center" valign="middle" style="text-align: center">材料规格</td>
            <td width="320" height="40" colspan="4" align="center" valign="middle" style="text-align: center">&nbsp;</td>
        </tr>
        <tr>
            <td width="80" height="40" colspan="1" align="center" valign="middle" style="text-align: center">下&nbsp;料&nbsp;人</td>
            <td width="160" height="40" colspan="2" align="center" valign="middle" style="text-align: center">&nbsp;</td>
            <td width="80" height="40" colspan="1" align="center" valign="middle" style="text-align: center">检&nbsp;验&nbsp;员</td>
            <td width="160" height="40" colspan="2" align="center" valign="middle" style="text-align: center">&nbsp;</td>
            <td width="80" height="40" colspan="1" align="center" valign="middle" style="text-align: center">库&nbsp;管&nbsp;员</td>
            <td width="160" height="40" colspan="2" align="center" valign="middle" style="text-align: center">&nbsp;</td>
        </tr>
        <tr>
            <td width="80" height="40" colspan="1" align="center" valign="middle" style="text-align: center">领&nbsp;料&nbsp;人</td>
            <td width="80" height="40" colspan="1" align="center" valign="middle" style="text-align: center">&nbsp;</td>
